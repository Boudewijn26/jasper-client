...
import audioop
import pyaudio
import client.alteration as alteration
...
class Mic:
    ...
    def fetchThreshold(self):
        ...
        for i in range(0, round(RATE / CHUNK * THRESHOLD_TIME)):
    ...
    def passiveListen(self, PERSONA):
        ...
        for i in range(0, round(RATE / CHUNK * LISTEN_TIME)):
        ...
        DELAY_MULTIPLIER = 1
        for i in range(0, round(RATE / CHUNK * DELAY_MULTIPLIER)):
